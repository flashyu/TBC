...
if (GetLocale() == "koKR") then
	...
	HEALBOT_HEAVY_NETHERWEAVE_BANDAGE = "두꺼운 황천매듭 붕대";
	HEALBOT_HEAVY_RUNECLOTH_BANDAGE = "두꺼운 룬매듭 붕대";
	HEALBOT_MAJOR_HEALING_POTION = "일급 치유 물약";
	HEALBOT_PURIFICATION_POTION = "정화 물약";
	HEALBOT_ANTI_VENOM = "해독제";
	HEALBOT_POWERFUL_ANTI_VENOM = "강력한 해독제";
	HEALBOT_ELIXIR_OF_POISON_RES = "독 저항의 비약";
	HEALBOT_STONEFORM = GetSpellInfo(20594);

	HEALBOT_FLASH_HEAL = "순간 치유";
	HEALBOT_FLASH_OF_LIGHT = "빛의 섬광";
	HEALBOT_GREATER_HEAL = "상급 치유";
	HEALBOT_BINDING_HEAL = "결속의 치유"
	HEALBOT_PRAYER_OF_MENDING = "회복의 기원";
	...
	HEALBOT_LIFEBLOOM = "피어나는 생명";
	HEALBOT_PRAYER_OF_HEALING = "치유의 기원";
	HEALBOT_CHAIN_HEAL = "연쇄 치유";

	HEALBOT_POWER_WORD_FORTITUDE = "신의 권능: 인내";
	HEALBOT_PRAYER_OF_FORTITUDE = "인내의 기원";
	HEALBOT_DIVINE_SPIRIT = "천상의 정신";
	HEALBOT_PRAYER_OF_SPIRIT = "정신력의 기원";
	HEALBOT_SHADOW_PROTECTION = '어둠의 보호';
	HEALBOT_PRAYER_OF_SHADOW_PROTECTION = '암흑 보호의 기원';
	HEALBOT_INNER_FIRE = "내면의 열정";
	HEALBOT_INNER_FOCUS = "내면의 집중력";
	HEALBOT_FEAR_WARD = "공포의 수호물";
	HEALBOT_TOUCH_OF_WEAKNESS = "무력의 손길";
	HEALBOT_ARCANE_INTELLECT = "신비한 지능";
	HEALBOT_ARCANE_BRILLIANCE = "신비한 총명함";
	HEALBOT_FROST_ARMOR = "냉기 갑옷";
	HEALBOT_ICE_ARMOR = "얼음 갑옷";
	HEALBOT_MAGE_ARMOR = "마법사 갑옷";
	HEALBOT_MOLTEN_ARMOR = "타오르는 갑옷";
	HEALBOT_DEMON_ARMOR = "악마의 갑옷";
	HEALBOT_DEMON_SKIN = "악마의 피부";
	HEALBOT_FEL_ARMOR = "마의 갑옷";
	HEALBOT_DAMPEN_MAGIC = "마법 감쇠";
	HEALBOT_AMPLIFY_MAGIC = "마법 증폭";
	HEALBOT_SHADOW_GUARD = "어둠의 수호";
	HEALBOT_DETECT_INV = "투명체 감지";

	HEALBOT_LIGHTNING_SHIELD = "번개 보호막";
	HEALBOT_ROCKBITER_WEAPON = "대지의 무기";
	HEALBOT_FLAMETONGUE_WEAPON = "불꽃의 무기";
	HEALBOT_FROSTBRAND_WEAPON = "냉기의 무기";
	HEALBOT_EARTH_SHIELD = "대지의 보호막";
	HEALBOT_WATER_SHIELD = "물의 보호막";
	HEALBOT_WIND_FURY = "질풍";

	HEALBOT_MARK_OF_THE_WILD = "야생의 징표";
	HEALBOT_GIFT_OF_THE_WILD = "야생의 선물";
	HEALBOT_THORNS = "가시";
	HEALBOT_OMEN_OF_CLARITY = "청명의 전조";

	HEALBOT_BLESSING_OF_MIGHT = "힘의 축복";
	HEALBOT_BLESSING_OF_WISDOM = "지혜의 축복";
	HEALBOT_BLESSING_OF_SALVATION = "구원의 축복";
	HEALBOT_BLESSING_OF_SANCTUARY = "성역의 축복";
	HEALBOT_BLESSING_OF_LIGHT = "빛의 축복";
	HEALBOT_BLESSING_OF_PROTECTION = "보호의 축복";
	HEALBOT_BLESSING_OF_FREEDOM = "자유의 축복";
	HEALBOT_BLESSING_OF_SACRIFICE = "희생의 축복";
	HEALBOT_BLESSING_OF_KINGS = "왕의 축복";
	HEALBOT_GREATER_BLESSING_OF_MIGHT = "상급 힘의 축복";
	HEALBOT_GREATER_BLESSING_OF_WISDOM = "상급 지혜의 축복";
	HEALBOT_GREATER_BLESSING_OF_KINGS = "상급 왕의 축복";
	HEALBOT_GREATER_BLESSING_OF_LIGHT = "상급 빛의 축복";
	HEALBOT_GREATER_BLESSING_OF_SALVATION = "상급 구원의 축복";
	HEALBOT_GREATER_BLESSING_OF_SANCTUARY = "상급 성역의 축복";
	HEALBOT_RIGHTEOUS_FURY = "정의의 격노"
	HEALBOT_DEVOTION_AURA = "기원의 오라"
	HEALBOT_RETRIBUTION_AURA = "응보의 오라"
	HEALBOT_CONCENTRATION_AURA = "집중의 오라"
	HEALBOT_SHR_AURA = "암흑 저항의 오라"
	HEALBOT_FRR_AURA = "냉기 저항의 오라"
	HEALBOT_FIR_AURA = "화염 저항의 오라"
	HEALBOT_CRUSADER_AURA = "성전사의 오라"
	HEALBOT_SANCTITY_AURA = "고결의 오라"

	HEALBOT_INTERVENE = GetSpellInfo(3411);

	HEALBOT_A_MONKEY = "원숭이의 상"
	HEALBOT_A_HAWK = "매의 상"
	HEALBOT_A_CHEETAH = "치타의 상"
	HEALBOT_A_BEAST = "야수의 상"
	HEALBOT_A_PACK = "치타 무리의 상"
	HEALBOT_A_WILD = "야생의 상"
	HEALBOT_A_VIPER = "독사의 상"
	HEALBOT_MENDPET = "동물 치료"

	HEALBOT_UNENDING_BREATH = "영원의 숨결"
	HEALBOT_HEALTH_FUNNEL = "생명력 집중"
	...
	HEALBOT_REMOVE_LESSER_CURSE = "하급 저주 해제";
	HEALBOT_DISEASE = "질병";
	HEALBOT_MAGIC = "마법";
	HEALBOT_CURSE = "저주";
	HEALBOT_POISON = "독";
...
--	HEALBOT_POISON_en          = "Poison";  -- Do NOT localize this value.
	...
	HEALBOT_DEBUFF_PSYCHIC_HORROR = "정신적 공포";
	HEALBOT_DEBUFF_HUNTERS_MARK = "사냥꾼의 징표";
	HEALBOT_DEBUFF_SLOW = "감속";
	HEALBOT_DEBUFF_ARCANE_BLAST = "신비한 폭발";
...
--	HB_SPELL_PATTERN_REJUVENATION2 = "Not needed for en";
	...
	HEALBOT_OPTIONS_HARDRESET = "UI 재실행"
	...
	HEALBOT_OPTIONS_SKINNUMHCOLS = "번호. 컬럼당 헤더"
	...
	HEALBOT_OPTIONS_SKINFHEIGHT = "문자 크기"
	...
	HEALBOT_OPTIONS_ENABLEHEALTHY = "항상 세팅 활성화 사용";
	...
	HEALBOT_OPTIONS_TARGETHEALS = "타겟";
	...
	HEALBOT_OPTIONS_SHOWHEALTHONBAR = "바에 체력 표시";
	...
	HEALBOT_OPTIONS_SHOWCLASSNAME = "이름 포함";
	HEALBOT_OPTIONS_BARCLASSCOLOUR	= "직업에 의한 바 색상";
	HEALBOT_OPTIONS_BARTEXTCLASSCOLOUR1 = "직업에 의한 문자 색상";
	HEALBOT_OPTIONS_BARTEXTCLASSCOLOUR2 = "디버프에 걸릴시 스킨 탭 위로 표시";
...
--	HEALBOT_EIGHT = "8";
	...
	HEALBOT_OPTIONS_SETDEFAULTSMSG = "모든 옵션을 기본값으로 초기화 합니다";
	HEALBOT_OPTIONS_RIGHTBOPTIONS = "우 클릭시 옵션 열기";

	HEALBOT_OPTIONS_HEADEROPTTEXT = "헤더 옵션";
	...
	HEALBOT_OPTIONS_MONITORBUFFSC = "전투 상태시";
	HEALBOT_OPTIONS_ENABLESMARTCAST  = "비 전투 상태시 신속시전";
	HEALBOT_OPTIONS_SMARTCASTSPELLS = "주문 포함";
	...
	HEALBOT_OPTIONS_ENABLEDBARS = "항상 바 활성화";
	HEALBOT_OPTIONS_DISABLEDBARS = "비 전투 상태시 바 비활성화";
	HEALBOT_OPTIONS_MONITORDEBUFFS  = "디버프 제거 모니터";
	HEALBOT_OPTIONS_DEBUFFTEXT1 = "디버프 제거 주문";

	HEALBOT_OPTIONS_IGNOREDEBUFF = "디버프 무시:";
	HEALBOT_OPTIONS_IGNOREDEBUFFCLASS = "관련없는 직업";
	...
	HEALBOT_OPTIONS_HIDEPARTYFRAMES = "파티 프레임 숨김";
	HEALBOT_OPTIONS_HIDEPLAYERTARGET = "플레이어와 대상 포함";
	HEALBOT_OPTIONS_DISABLEHEALBOT = "HealBot 비활성화";
	...
	HEALBOT_TITAN_EXTRABARS = "확장 바";
	HEALBOT_BUTTON_TOOLTIP = "HealBot 옵션 패널을 열기위해 왼쪽 버튼을 클릭하세요.";
	...
	HEALBOT_OPTIONS_ENABLETARGETSTATUS = "대상과의 전투중 설정 가능";
	...
	HEALBOT_OPTION_BARUPDFREQ = "바 업데이트 빈도"
	HEALBOT_OPTION_USEFLUIDBARS = "유동적 바 사용"
	HEALBOT_OPTION_CPUPROFILE  = "CPU 프로필 사용 (애드온 CPU 사용 정보)"
	HEALBOT_OPTIONS_SETCPUPROFILERMSG = "이 옵션은 UI 재실행이 필요합니다, 다시 실행하시겠습니까?"

	HEALBOT_SELF_PVP = "PvP 자신"
	HEALBOT_OPTIONS_ANCHOR = "앵커"
