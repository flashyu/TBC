...
HEALBOT_PURIFICATION_POTION     = "L\195\164uterungstrank";
HEALBOT_ANTI_VENOM              = "Gegengift";
HEALBOT_POWERFUL_ANTI_VENOM     = "M\195\164chtiges Gegengift";
HEALBOT_ELIXIR_OF_POISON_RES    = "Elixier des Giftwiderstands";

HEALBOT_FLASH_HEAL          = "Blitzheilung";
HEALBOT_FLASH_OF_LIGHT      = "Lichtblitz";
HEALBOT_GREATER_HEAL        = "Gro\195\159e Heilung";
HEALBOT_BINDING_HEAL        = "Verbindende Heilung";
HEALBOT_PRAYER_OF_MENDING   = "Gebet der Besserung";
...
HEALBOT_LIFEBLOOM           = "Bl\195\188hendes Leben";
...
HEALBOT_PRAYER_OF_FORTITUDE   = "Gebet der Seelenst\195\164rke";
HEALBOT_DIVINE_SPIRIT         = "G\195\182ttlicher Wille";
HEALBOT_PRAYER_OF_SPIRIT      = "Gebet der Willenskraft";
HEALBOT_SHADOW_PROTECTION     = "Schattenschutz";
HEALBOT_PRAYER_OF_SHADOW_PROTECTION = "Gebet des Schattenschutzes";
HEALBOT_INNER_FIRE            = "Inneres Feuer";
HEALBOT_INNER_FOCUS           = "Innerer Fokus";
HEALBOT_FEAR_WARD           = "Furchtzauberschutz";
HEALBOT_TOUCH_OF_WEAKNESS     = "Ber\195\188hrung der Schw\195\164che";
HEALBOT_ARCANE_INTELLECT      = "Arkane Intelligenz";
HEALBOT_ARCANE_BRILLIANCE     = "Arkane Brillanz";
HEALBOT_FROST_ARMOR           = "Frostr\195\188stung";
HEALBOT_ICE_ARMOR             = "Eisr\195\188stung";
HEALBOT_MAGE_ARMOR            = "Magische R\195\188stung";
HEALBOT_MOLTEN_ARMOR          = "Gl/195/188hende R/195/188stung";
HEALBOT_DEMON_ARMOR           = "D\195\164monenr\195\188stung";
HEALBOT_DEMON_SKIN            = "D\195\164monenhaut";
HEALBOT_FEL_ARMOR             = "Teufelsr\195\188stung";   
HEALBOT_DAMPEN_MAGIC          = "Magie d/195/164mpfen";
HEALBOT_AMPLIFY_MAGIC         = "Magie verst/195/164rken";
HEALBOT_SHADOW_GUARD          = "Schattenschild";   

HEALBOT_LIGHTNING_SHIELD      = "Blitzschlagschild";    
HEALBOT_ROCKBITER_WEAPON      = "Waffe des Felsbeißers";    
HEALBOT_FLAMETONGUE_WEAPON    = "Waffe der Flammenzunge";    
HEALBOT_FROSTBRAND_WEAPON     = "Waffe des Frostbrands";     
HEALBOT_EARTH_SHIELD          = "Erdschild";              
HEALBOT_WATER_SHIELD          = "Wasserschild";              
HEALBOT_WIND_FURY             = "Waffe des Windzorns";       

HEALBOT_MARK_OF_THE_WILD      = "Mal der Wildnis";
HEALBOT_GIFT_OF_THE_WILD      = "Gabe der Wildnis";
HEALBOT_THORNS                = "Dornen";
HEALBOT_OMEN_OF_CLARITY       = "Omen der Klarsicht";

HEALBOT_BLESSING_OF_MIGHT       = "Segen der Macht";
HEALBOT_BLESSING_OF_WISDOM      = "Segen der Weisheit";
HEALBOT_BLESSING_OF_SALVATION   = "Segen der Rettung";
HEALBOT_BLESSING_OF_SANCTUARY   = "Segen des Refugiums";
HEALBOT_BLESSING_OF_LIGHT       = "Segen des Lichts";
HEALBOT_BLESSING_OF_PROTECTION  = "Segen des Schutzes";
HEALBOT_BLESSING_OF_FREEDOM     = "Segen der Freiheit";
HEALBOT_BLESSING_OF_SACRIFICE   = "Segen der Opferung";
HEALBOT_BLESSING_OF_KINGS       = "Segen der K\195\182nige";
HEALBOT_GREATER_BLESSING_OF_MIGHT     = "Gro\195\159er Segen der Macht";
HEALBOT_GREATER_BLESSING_OF_WISDOM    = "Gro\195\159er Segen der Weisheit";
HEALBOT_GREATER_BLESSING_OF_KINGS     = "Gro\195\159er Segen der K\195\182nige";
HEALBOT_GREATER_BLESSING_OF_LIGHT     = "Gro\195\159er Segen des Lichts";
HEALBOT_GREATER_BLESSING_OF_SALVATION = "Gro\195\159er Segen der Rettung";
HEALBOT_GREATER_BLESSING_OF_SANCTUARY = "Gro\195\159er Segen des Refugiums";
HEALBOT_RIGHTEOUS_FURY          = "Zorn der Gerechtigkeit"; 
HEALBOT_DEVOTION_AURA           = "Aura der Hingabe"; 
HEALBOT_RETRIBUTION_AURA        = "Aura der Vergeltung"; 
HEALBOT_CONCENTRATION_AURA      = "Aura der Konzentration"; 
HEALBOT_SHR_AURA                = "Aura des Schattenwiderstands"; 
HEALBOT_FRR_AURA                = "Aura des Frostwiderstands"; 
HEALBOT_FIR_AURA                = "Aura des Feuerwiderstands"; 
HEALBOT_CRUSADER_AURA           = "Aura des Kreuzfahrers"; 
HEALBOT_SANCTITY_AURA           = "Aura der Heiligkeit";

HEALBOT_MENDPET       = "Tier heilen"; 
HEALBOT_A_MONKEY      = "Aspekt des Affen"; 
HEALBOT_A_HAWK        = "Aspekt des Falken"; 
HEALBOT_A_CHEETAH     = "Aspekt des Geparden"; 
HEALBOT_A_BEAST       = "Aspekt des Wildtiers"; 
HEALBOT_A_PACK        = "Aspekt des Rudels"; 
HEALBOT_A_WILD        = "Aspekt der Wildniss"; 
HEALBOT_A_VIPER       = "Aspekt der Viper";
...
HHEALBOT_DEBUFF_HOWLINGSCREECH  = "Heulender Schrei";
...
HB_SPELL_PATTERN_FLASH_HEAL          = "Heilt ein befreundetes Ziel um (%d+) bis (%d+)";
...
HB_HASLEFTRAID                       = "^([^%s]+) hat die RAID Gruppe verlassen%.$";
...
HB_YOUJOINTHERAID                    = "Du bist der RAID Gruppe beigetreten";
HB_YOUJOINTHEGROUP                   = "Du bist der Gruppe beigetreten";
...
HEALBOT_OPTIONS_SKINNUMHCOLS  = "Nr. \195\156berschriften pro Spalte";
...
HEALBOT_OPTIONS_CASTNOTIFY6   = "Benachrichtigungs Channel";
...
HEALBOT_TOOLTIP_POSCURSOR       = "Neben dem Mauszeiger";
...
HEALBOT_OPTIONS_SHOWHEALTHONBAR = "Zeige Leben auf Leiste";
...
HEALBOT_OPTIONS_BARINFOTEXT     = "Leisten Anzeige";
HEALBOT_OPTIONS_POSTOOLTIP      = "Tooltip Position";
HEALBOT_OPTIONS_SHOWCLASSNAME   = "mit Namen";
HEALBOT_OPTIONS_BARCLASSCOLOUR	= "Color bar by class";
HEALBOT_OPTIONS_BARTEXTCLASSCOLOUR1 = "Zeige Text in Klassenfarben";
...
HEALBOT_OPTIONS_RIGHTBOPTIONS  = "Rechts-Klick auf Panel \195\182ffnet Optionen";

HEALBOT_OPTIONS_HEADEROPTTEXT = "\195\188berschriften Optionen"; 
HEALBOT_SKIN_HEADERBARCOL = "Balken farbe"; 
HEALBOT_SKIN_HEADERTEXTCOL = "Text farbe"; 
HEALBOT_OPTIONS_BUFFSTEXT1 = "Buff Typ"; 
HEALBOT_OPTIONS_BUFFSTEXT2 = "auf Mitglieder"; 
HEALBOT_OPTIONS_BUFFSTEXT3 = "Balken farbe"; 
...
HEALBOT_OPTIONS_MONITORBUFFS = "\195\156berwachung f\195\188r fehlende Buffs"; 
HEALBOT_OPTIONS_MONITORBUFFSC = "auch im Kampf"; 
HEALBOT_OPTIONS_ENABLESMARTCAST = "SmartCast ausserhalb des Kampfs"; 
HEALBOT_OPTIONS_SMARTCASTSPELLS = "Optionen"; 
...
HEALBOT_OPTIONS_BAR2SIZE = "Mana Balken gr\195\182ße"; 
HEALBOT_OPTIONS_SETSPELLS = "Setze Zauber f\195\188r"; 
HEALBOT_OPTIONS_ENABLEDBARS = "Aktive Balken zu jeder Zeit"; 
HEALBOT_OPTIONS_DISABLEDBARS = "Inaktive Balken ausserhalb Kampf"; 
...
HEALBOT_OPTIONS_IGNOREDEBUFFCLASS = "Klassen irrelevant"; 
HEALBOT_OPTIONS_IGNOREDEBUFFMOVEMENT = "Verlangsamungs Effekte"; 
...
HEALBOT_OPTIONS_HIDEPARTYFRAMES = "Gruppenportraits ausblenden";
...
HEALBOT_TITAN_SHOWBARS       = "Zeige Leisten f\195\188r";
HEALBOT_TITAN_EXTRABARS      = "Extra Leisten";
...
HEALBOT_OPTIONS_HOTONBAR     = "auf Leiste";
HEALBOT_OPTIONS_HOTOFFBAR    = "neben Leiste";
HEALBOT_OPTIONS_HOTBARRIGHT  = "Rechte Seite";
HEALBOT_OPTIONS_HOTBARLEFT   = "Linke Seite";

HEALBOT_OPTIONS_ENABLETARGETSTATUS = "Verwende aktivierte Einstellungen wenn das Ziel im Kampf ist";
...
HEALBOT_OPTION_AGGROTRACK = "Aggro aufspüren"; 
HEALBOT_OPTION_AGGROBAR = "Aufblitzende Balken"; 
HEALBOT_OPTION_AGGROTXT = ">> Zeige Text <<"; 
HEALBOT_OPTION_BARUPDFREQ = "Balken-Aktualisierungsfrequenz";
HEALBOT_OPTION_USEFLUIDBARS = "Bars flie\195\159end zeichnen";
