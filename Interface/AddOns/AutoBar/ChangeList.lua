 ...
 * Custom Categories need to be able to pick [http://www.wowace.com/wiki/LibPeriodicTable-3.1 LibPeriodicTable-3.1] sets for their contents.
...
-- First cut of Shuffle:
--- It shuffles consumable items for a particular slot.
...
--- Enable Shuffle on a button from the UI for Buttons.
