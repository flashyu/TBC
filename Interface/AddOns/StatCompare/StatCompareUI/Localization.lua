...
if ( GetLocale() == "zhCN" ) then
	...
	STATCOMPARE_DISPLAY_RESILIENCE	= "韧性";
	STATCOMPARE_DISPLAY_HASTEMELEE	= "物理急速";
	STATCOMPARE_DISPLAY_HASTESPELL	= "法术急速";
	STATCOMPARE_DISPLAY_IGNOREARMOR	= "无视护甲";
	...
	STATCOMPARE_SHOW_TALENTBONUS = "统计装备属性时加入天赋加成统计信息";
...
elseif( GetLocale() == "zhTW" ) then
	...
	STATCOMPARE_DISPLAY_RESILIENCE	= "韌性";
	...
	STATCOMPARE_SHOW_TALENTBONUS = "裝備屬性統計时加入天賦統計信息";
else
	...
	STATCOMPARE_DISPLAY_RESILIENCE	= "Resilience";
	...
	STATCOMPARE_SHOW_TALENTBONUS = "Show talent bonus info in StatCompare window";
end