...
STATCOMPARE_PATTERN_GENERIC_PREFIX_AND_CN = "^%+?(%d+)%s?%%?([^，]*)，";
STATCOMPARE_PATTERN_GENERIC_PREFIX_AND_EN = "^%+?(%d+)%%?(.*) and ";
STATCOMPARE_PATTERN_GENERIC_SUFFIX_AND_CN = "^([^，]*)%+?(%d+)%s?%%?，";
STATCOMPARE_PATTERN_GENERIC_SUFFIX_AND_EN = "^(.*)%+?(%d+)%%? and ";
STATCOMPARE_ALLANDS = { "/", ", ", " & ", "，", " and " };

STATCOMPARE_ITEMLINK_PATTERN = "^|cff(......)|Hitem:(%d+:%d+:%d+:%d+):(%d+):(%d+):(%d+):(%-?%d+):(%d+)|h%[(.+)%]|h|r$"
...
STATCOMPARE_EFFECTS = {
	...
	{ effect = "DEFENSER",		name = STATCOMPARE_DEFENSE, 		format = "+%d",	show = 0,	lformat = "%d",		short = "YDEF",	cat = "SKILL",	opt="ShowDefense" },
	...
	{ effect = "RESILIENCE",	name = STATCOMPARE_RESILIENCE,		format = "%d",	show = 1, short = "MA", cat = "BON", opt = "ShowResilience"},
	{ effect = "DMGTAKEN",		name = STATCOMPARE_DMGTAKEN,		format = "-%.2f%%",	show = 1, short = "ID", cat = "BON", opt = "ShowResilience"},
	{ effect = "CRITTAKEN",		name = STATCOMPARE_CRITTAKEN,		format = "-%.2f%%",	show = 1, short = "ID", cat = "BON", opt = "ShowResilience"},
	{ effect = "ATTACKPOWER",	name = STATCOMPARE_ATTACKPOWER, 		format = "+%d",	lformat = "%d",		show = 1,	short = "MA",	cat = "BON",	opt="ShowAP" },
	{ effect = "HASTEMELEE",	name = STATCOMPARE_HASTEMELEE, 		format = "+%.2f%%",	lformat = "%.2f%%",show = 1,	short = "HM",	cat = "BON" },
	{ effect = "HASTEMELEER",	name = STATCOMPARE_HASTEMELEE, 		format = "+%d",	lformat = "%.2f%%",show = 0,	short = "HM",	cat = "BON"},
	...
	{ effect = "CRIT",		name = STATCOMPARE_CRIT, 			format = "+%.2f%%",	lformat = "%.2f%%",	show = 1,	short = "MC",	cat = "BON",	opt="ShowCrit" },
	{ effect = "CRITR",		name = STATCOMPARE_CRIT, 			format = "+%d",	show = 0,	lformat = "%.2f%%",	short = "MC",	cat = "BON",	opt="ShowCrit" },
	{ effect = "BLOCK",		name = STATCOMPARE_BLOCK, 		format = "+%d",	lformat = "%d",	short = "MB",	show = 1,	cat = "BON",	opt="ShowBlock" },
	{ effect = "TOBLOCK",		name = STATCOMPARE_TOBLOCK, 		format = "+%.2f%%",	lformat = "%.2f%%",	short = "MB",	cat = "BON",	opt="ShowToBlock" },
	{ effect = "TOBLOCKR",		name = STATCOMPARE_TOBLOCK, 		format = "+%d",	show=0,	short = "MB",	cat = "BON",	opt="ShowToBlock" },
	{ effect = "DODGE",		name = STATCOMPARE_DODGE, 		format = "+%.2f%%",	lformat = "%.2f%%",	show = 1,	short = "MD",	cat = "BON",	opt="ShowDodge" },
	{ effect = "DODGER",		name = STATCOMPARE_DODGE, 		format = "+%d",	show = 0,	short = "MD",	cat = "BON",	opt="ShowDodge" },
	{ effect = "PARRY", 		name = STATCOMPARE_PARRY, 		format = "+%.2f%%",	lformat = "%.2f%%",	short = "MP",	cat = "BON",	opt="ShowParry" },
	{ effect = "PARRYR", 		name = STATCOMPARE_PARRY, 		format = "+%d",	show = 0,	lformat = "%.2f%%",	short = "MP",	cat = "BON",	opt="ShowParry" },
	{ effect = "TOHIT", 		name = STATCOMPARE_TOHIT, 		format = "+%.2f%%",	lformat = "%.2f%%",	short = "MH",	cat = "BON",	opt="ShowToHit" },
	{ effect = "TOHITR", 		name = STATCOMPARE_TOHIT, 		format = "+%d",	show = 0,	lformat = "%.2f%%",	short = "MH",	cat = "BON",	opt="ShowToHit" },
	{ effect = "EXPERTISER", 	name = STATCOMPARE_EXPERTISE, 		format = "+%d",		lformat = "%d",	short = "MH",	cat = "BON"},
	{ effect = "NOARM",	 	name = STATCOMPARE_IGNOREARMOR, 	format = "+%d",		lformat = "%d",	short = "MH",	cat = "BON"},
	...
	{ effect = "SPELLCRIT", 	name = STATCOMPARE_SPELLCRIT,		format = "+%.2f%%",	lformat = "%.2f%%",	short = "CSC",	cat = "SBON" },
	{ effect = "SPELLCRITR", 	name = STATCOMPARE_SPELLCRIT,		format = "+%d",	show = 0,	lformat = "%.2f%%",	short = "CSC",	cat = "SBON" },
	{ effect = "HASTESPELL", 	name = STATCOMPARE_HASTESPELL,		format = "+%.2f%%",	lformat = "%.2f%%", short = "CHS",	cat = "SBON" },
	{ effect = "HASTESPELLR", 	name = STATCOMPARE_HASTESPELL,		format = "+%d",	show = 0,	lformat = "%.2f%%", short = "CHS",	cat = "SBON" },
	{ effect = "SPELLTOHIT", 	name = STATCOMPARE_SPELLTOHIT,		format = "+%.2f%%",	lformat = "%.2f%%",	short = "CSH",	cat = "SBON" },
	{ effect = "SPELLTOHITR", 	name = STATCOMPARE_SPELLTOHIT,		format = "+%d",	show = 0,	lformat = "%.2f%%",	short = "CSH",	cat = "SBON" },
...
function StatCompare_SetupHook(enable)
	...
	if(SuperInspectFrame) then
		if (enable == 1) then
			if ((SuperInspect_InspectTarget ~=SCSuperInspect_InspectFrame_Show) and (scoldSuperInspect_InspectFrame_Show ==nil)) then
				scoldSuperInspect_InspectFrame_Show =  SuperInspect_InspectTarget;
				SuperInspect_InspectTarget = SCSuperInspect_InspectFrame_Show;
			end
			...
			if (SuperInspect_InspectTarget == SCSuperInspect_InspectFrame_Show) then
				SuperInspect_InspectTarget = scoldSuperInspect_InspectFrame_Show;
...
function StatCompare_Register(register)
	if (register == 1) then
		...
		this:UnregisterEvent("INSPECT_TALENT_READY");
	end
end
...
function StatCompare_OnEvent()
	...
	elseif (event == "INSPECT_TALENT_READY") then
		if ( StatCompare_enable and StatCompare_isLoaded==1 and StatCompareTargetFrame:IsVisible()) then
			SCHideFrame(StatCompareTargetFrame);
			StatCompare_ScanAll("target");
			local tiptext = StatCompare_GetTooltipText(StatScanner_bonuses,0);
			SCShowFrame(StatCompareTargetFrame,InspectFrame,UnitName("target"),tiptext,-30,-12);
...
function StatCompare_GetTooltipText(bonuses,bSelfStat)
	...
	if(bSelfStat==1) then
		...
		baseval["CRIT"] = GetCritChance("player");
		if(baseval["CRIT"] == 0) then
			baseval["CRIT"] = nil;
		end
		...
		baseval["SPELLCRIT"] = minCrit;
		if(baseval["SPELLCRIT"] == 0) then
			baseval["CRIT"] = nil;
		end
		...
		baseval["ATTACKPOWER"] = max(baseval["ATTACKPOWER"] + posBuff + negBuff, 0);
		baseval["RANGEDATTACKPOWER"], posBuff, negBuff = UnitRangedAttackPower("player");
		baseval["RANGEDATTACKPOWER"] = max(baseval["RANGEDATTACKPOWER"] + posBuff + negBuff, 0);
	...
	for i,v in pairs(StatScanner_setcount) do
		if(v.color) then
			...
			setstr=setstr..NORMAL_FONT_COLOR_CODE..i..v.count.."/"..v.total.."）"..FONT_COLOR_CODE_CLOSE.."\n";
		end
	end
...
function StatCompare_ScanAll(unit)
	local showTalentBonus = StatCompare_GetSetting("ShowTalentBonus");
	
	StatScanner_ScanAllInspect(unit);
	if(SC_BuffScanner_ScanAllInspect) then
		-- Scan the buffers
		SC_BuffScanner_ScanAllInspect(StatScanner_bonuses, unit);
	end
	if(StatCompare_CharStats_Scan) then
		StatCompare_CharStats_Scan(StatScanner_bonuses, unit);
	end

	if(showTalentBonus == 1) then
		StatCompare_StatModifer(unit);
		if(StatCompare_CharStats_Scan) then
			StatCompare_CharStats_Scan(StatScanner_bonuses, unit);
		end	
	end
